...
typedef enum APP_STATUS {
	WIFI_STA_PRO_TESTCOMPLETE=0X02,
	WIFI_STA_CONNECT_SERVER = 0X04, 
	WIFI_STA_DISCONNCT_SERVER = 0X08,
	WIFI_STA_APP_CONNECT = 0X10,  
	WIFI_STA_APP_DISCONNECT = 0X20, 
	WIFI_STA_APP_TIMEOUT = 0X40,  
	WIFI_STA_LOGIN_SUCCESS = 0X80, 
} APP_STATUS;
